...
namespace ora {
    ...
    {17, 1, "KCVOPEHB", "End Hot Backup. This operation clears the hot backup in-progress flags in the indicated list of files" },
    {17, 2, "KCVOPENT", "ENable Thread This operation creates a redo record signalling that a thread has been enabled" },
