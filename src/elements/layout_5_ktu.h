...
#pragma pack(push, 1)
    ...
    */
    struct Ktudh {
        ...
        uint8_t  uba_num;   // (1 byte, offset 14) Undo Block Address: Record#
...
#pragma pack(pop)
    ...
    inline Ktudh decode_ktudh0(tcb::span<const char> buf) {
        return Ktudh{
            ...
            .uba_num  = decode_at<uint8_t,  IsLittle>(buf, 14),
...
#pragma pack(push, 1)
    ...
    struct Ktucf {
        ...
        uint8_t  uba_num;      // (1 byte, offset 6) undo block addr rec#
...
#pragma pack(pop)
    ...
    inline Ktucf decode_ktucf0(tcb::span<const char> buf) {
        return Ktucf{
            ...
            .uba_num  = decode_at<uint8_t,  IsLittle>(buf, 6),
